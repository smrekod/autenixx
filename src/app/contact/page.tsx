...
const contactOptions = [
  {
    ...
    title: "Sales",
    description:
      "Talk to our sales team about pricing and enterprise solutions",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            ...
            <motion.p
              ...
              Have questions about Autenix? We&apos;re here to help. Reach out
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-surface-600 mb-5">
              See Autenix in action with a personalized walkthrough.
            </p>
