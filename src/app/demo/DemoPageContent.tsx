...
const benefits = [
  {
    icon: Shield,
    title: "Personalized Compliance Demo",
    description:
      "See how Autenix works for your specific SOC 2, ISO 27001, or HIPAA compliance needs",
  },
  {
    icon: Clock,
    title: "30-Minute Overview",
    description:
      "Quick overview of key compliance automation features and capabilities",
  },
  {
    icon: Users,
    title: "Expert Compliance Guidance",
    description:
      "Talk to compliance experts who understand your framework challenges",
  },
];

const features = [
  "Live platform walkthrough",
  "SOC 2, ISO 27001, HIPAA demonstration",
  "AWS, Azure, GCP integration overview",
      ...
      <div className="pt-20 min-h-screen flex items-center justify-center hero-gradient-bg">
        <motion.div
          ...
          <p className="text-lg text-surface-600 mb-8">
            Thank you for your interest in Autenix compliance automation. Our
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
            <AnimatedSection>
              ...
              <motion.p
                ...
                Get a personalized demo of Autenix and see how we help
                ...
                , and other compliance certifications faster with automation.
              </motion.p>
            ...
            <AnimatedSection delay={0.2} direction="left">
              <motion.div
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-surface-700 mb-1.5">
                      Anything specific about your compliance needs?
                    </label>
                    <textarea
