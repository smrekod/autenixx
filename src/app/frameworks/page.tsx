...
const categories = [
  { name: "Security", frameworks: ["SOC 2", "ISO 27001", "CIS"], icon: Shield },
  { name: "Healthcare", frameworks: ["HIPAA"], icon: FileCheck },
  { name: "Financial", frameworks: ["PCI-DSS"], icon: Lock },
  { name: "Privacy", frameworks: ["GDPR"], icon: Globe },
  { name: "Government", frameworks: ["NIST", "FedRAMP"], icon: Building },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <AnimatedSection className="max-w-3xl">
            <motion.h1
              ...
              Compliance{" "}
              <span className="gradient-text-emerald">Frameworks</span>
            </motion.h1>
            ...
            <motion.p
              ...
              Comprehensive support for all major compliance frameworks.
              Automated control mapping, continuous monitoring, and audit-ready
              evidence.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-base text-surface-600 mb-6 max-w-2xl mx-auto">
              We also support CMMC, CJIS, NIS2, DORA, CPS 234, EU AI Act,
              Essential Eight, Cyber Essentials, and custom frameworks.
            </p>
            <Button
              size="lg"
              variant="outline"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            ...
            <p className="text-base text-white mb-6">
              See how Autenix can help you meet your compliance requirements.
            </p>
