...
const faqs = [
  {
    ...
    answer:
      "Our pricing is customized based on your organization's size, compliance needs, and the number of frameworks you require. Schedule a demo to get a personalized quote.",
  },
  {
    question: "Do you offer a free trial?",
    answer:
      "We offer personalized demos where you can see the platform in action with your specific use case. Contact our team to schedule a demo.",
  },
  {
    question: "What frameworks do you support?",
    answer:
      "We support 35+ compliance frameworks including SOC 2, ISO 27001, HIPAA, GDPR, PCI DSS, and many more. We're continuously adding new frameworks based on customer needs.",
  },
  {
    question: "Do you offer discounts for startups?",
    answer:
      "Yes, we have special pricing for early-stage startups. Contact our sales team to learn more about our startup program.",
  },
  {
    question: "What's included in onboarding?",
    answer:
      "Every customer receives dedicated onboarding support including initial setup, integration configuration, team training, and ongoing success management.",
  },
  {
    question: "Can I switch plans later?",
    answer:
      "Yes! You can upgrade or adjust your plan at any time as your compliance needs evolve. We'll work with you to ensure you have the right coverage.",
  },
];
...
const benefits = [
  {
    ...
    description:
      "Get up and running in days, not months. Our team handles the heavy lifting.",
  },
  {
    icon: Zap,
    title: "Automated Monitoring",
    description:
      "Continuous compliance monitoring with real-time alerts and automated remediation.",
  },
  {
    icon: Building2,
    title: "Dedicated Support",
    description:
      "Work directly with compliance experts who understand your needs.",
  },
];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            ...
            <p className="text-lg text-surface-600 max-w-2xl mx-auto mb-8">
              Every organization is unique. Get a personalized demo and pricing
              tailored to your specific compliance requirements.
            </p>
            ...
            <div className="bg-gradient-to-br from-surface-900 via-surface-900 to-surface-800 rounded-2xl p-6 md:p-10 text-center relative overflow-hidden">
              ...
              <div className="relative">
                <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
                  See Autenix in Action
                </h2>
                <p className="text-base text-surface-300 max-w-xl mx-auto mb-6">
                  Schedule a personalized demo to see how Autenix can streamline
                  your compliance journey and get custom pricing for your
                  organization.
                </p>
                <Button
                  size="lg"
