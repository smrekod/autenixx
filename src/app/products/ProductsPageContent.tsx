        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <AnimatedSection className="max-w-3xl">
            <motion.h1
              ...
              <span className="gradient-text">Products & Features</span>
            </motion.h1>
            ...
            <motion.p
              ...
              Everything you need to achieve, maintain, and prove compliance with{" "}
              ...
              <Link href="/frameworks/hipaa" className="text-brand-600 hover:underline">HIPAA</Link>, and 35+ other frameworks.
                ...
                <StaggerItem key={product.slug}>
                  <Link
                    ...
                    <span className="inline-flex items-center gap-1.5 text-brand-600 font-medium group-hover:gap-2.5 transition-all">
                      Learn more about {product.title.toLowerCase()}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-lg text-surface-600 mb-8">
              See how Autenix can help you achieve <Link href="/frameworks/soc-2" className="text-brand-600 hover:underline">SOC 2</Link>, <Link href="/frameworks/iso-27001" className="text-brand-600 hover:underline">ISO 27001</Link>, and <Link href="/frameworks/hipaa" className="text-brand-600 hover:underline">HIPAA</Link> compliance faster with our complete platform.
            </p>
