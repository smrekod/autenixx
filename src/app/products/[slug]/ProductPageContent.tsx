          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              ...
              <motion.p
                ...
                {product.description} Works seamlessly with{" "}
                ...
                <Link href="/frameworks/hipaa" className="text-brand-600 hover:underline">HIPAA</Link>, and 35+ other compliance frameworks.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-surface-900 tracking-tight">
              {product.title} Features for Compliance Automation
            </h2>
          </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-surface-900 mb-3 tracking-tight">
              Explore Other Compliance Products
            </h2>
            <p className="text-base text-surface-600">
              Discover the complete Autenix compliance automation platform
            </p>
          </AnimatedSection>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            ...
            <motion.p
              ...
              See how Autenix can transform your{" "}
              <Link href="/frameworks/soc-2" className="text-brand-300 hover:underline">SOC 2</Link>,{" "}
              <Link href="/frameworks/iso-27001" className="text-brand-300 hover:underline">ISO 27001</Link>, or{" "}
              <Link href="/frameworks/hipaa" className="text-brand-300 hover:underline">HIPAA</Link> compliance program.
            </motion.p>
