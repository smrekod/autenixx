...
const features = [
  {
    ...
    description:
      "Map custom controls and frameworks specific to your organization.",
  },
  {
    icon: Lock,
    title: "Advanced Security",
    description:
      "SSO, SCIM provisioning, audit logs, and enterprise-grade encryption.",
  },
  {
    icon: Headphones,
    title: "Dedicated Support",
    description: "Named account manager and priority support SLAs.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              <motion.h1
                ...
                Enterprise-Grade{" "}
                <span className="gradient-text-violet">Compliance</span>
              </motion.h1>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <AnimatedSection>
              ...
              <p className="text-surface-600 mb-5">
                Everything you need for enterprise-scale compliance management.
              </p>
              <FeatureList
                features={benefits}
                variant="minimal"
