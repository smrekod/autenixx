...
const features = [
  {
    ...
    description:
      "Manage multiple compliance frameworks with shared controls and evidence.",
  },
  {
    icon: Users,
    title: "Team Collaboration",
    description: "Assign tasks, track progress, and collaborate across teams.",
  },
  {
    icon: BarChart3,
    title: "Advanced Reporting",
    description: "Executive dashboards and custom reports for stakeholders.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              <motion.h1
                ...
                Scale Your{" "}
                <span className="gradient-text">Compliance Program</span>
              </motion.h1>
              ...
              <motion.p
                ...
                Autenix scales with you—supporting multiple frameworks, teams,
                and integrations.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-6">
            ...
            <p className="text-base text-surface-600">
              Everything you need to manage compliance at scale, from
            ...
            <AnimatedSection delay={0.2} direction="left">
              <motion.div
                ...
                <p className="text-surface-600 mb-6">
                  Perfect for companies scaling their compliance program
                </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            ...
            <p className="text-base text-white mb-6">
              See how Autenix can help you manage compliance at scale.
            </p>
