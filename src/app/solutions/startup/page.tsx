...
const features = [
  {
    ...
    title: "Quick Setup",
    description:
      "Get started in minutes with guided onboarding and pre-built templates.",
  },
  {
    icon: Clock,
    title: "Fast Time to Compliance",
    description: "Achieve your first certification in weeks, not months.",
  },
  {
    icon: Target,
    title: "Focus on What Matters",
    description: "Essential controls coverage without enterprise complexity.",
  },
];

const benefits = [
  "Pre-built policy templates for startups",
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              ...
              <motion.p
                ...
                Your first SOC 2 or ISO 27001 shouldn&apos;t slow you down.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-6">
            ...
            <p className="text-base text-surface-600">
              ...
              we&apos;ve designed our platform to get you compliant without
              slowing you down.
            </p>
          </AnimatedSection>
                ...
                <div className="space-y-4">
                  <motion.div
                    ...
                    <p className="text-sm text-surface-600">
                      The most requested compliance framework by enterprise
                      customers
                    </p>
                  </motion.div>
                  <motion.div
                    ...
                    <p className="text-sm text-surface-600">
                      International standard for expanding globally
                    </p>
                  </motion.div>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              Ready to get your first certification?
            </h2>

            <p className="text-base text-white mb-6">
              Join hundreds of startups using Autenix to achieve compliance.
            </p>
